...
router.get('/sales/returns', chalanController.getChalanReturnRecords);
...
router.post('/sales/:id/return', chalanController.processChalanReturn);
router.post('/sales/:id/revert-return', chalanController.revertChalanReturn);
