...
router.get('/damage-list', staffController.getDamageList);
router.post('/damage-list', staffController.createDamageListItem);
router.put('/damage-list/:id', staffController.updateDamageListItem);
...
router.post('/:id/outlets-upload', upload.single('file'), staffController.uploadOutletsExcel);
